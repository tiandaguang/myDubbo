            ...
            for (RegistryConfig config : registries) {
                ...
                if (!RegistryConfig.NO_AVAILABLE.equalsIgnoreCase(address)) {
                    ...
                    for (URL url : urls) {
                        ...
                        System.out.println("url.getParameter(Constants.REGISTER_KEY, true)" + url.getParameter(Constants.REGISTER_KEY, true));
                        System.out.println(" url.getParameter(Constants.SUBSCRIBE_KEY, true" +  url.getParameter(Constants.SUBSCRIBE_KEY, true));
...
//        registryIds = "wewws";
    ...
    public static void main(String[] args) {
        String normalizedMock = Constants.RETURN_PREFIX.concat("aaaa");
        System.out.println(normalizedMock = normalizedMock.substring(Constants.RETURN_PREFIX.length()).trim());
    }
}
